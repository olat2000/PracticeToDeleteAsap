...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("Calculator")]
        public virtual void AddTwoNumbersUsingScenarioContext()
        {
            string[] tagsOfScenario = new string[] {
                    "Calculator"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Add two numbers using scenario context", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 12
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
